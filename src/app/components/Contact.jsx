...
export default function Contact() {
  ...
  return (
      ...
      <div className="container flex flex-col  md:flex-row items-center justify-between text-xl  gap-4">
        <p className='text-white drop-shadow-[0_0_5px_#ffffff] drop-shadow-[0_0_10px_#ffffff] drop-shadow-[0_0_20px_#ffffff] drop-shadow-[0_0_40px_#ffffff]'>         Saleh Bayduon</p>
